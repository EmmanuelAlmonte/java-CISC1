...
* The Test scores are in a sepearte txt file and will be stored in an array.
* Created for CSCI 111
* last modified November 29, 2020.
* @ author A. Emmanuel
* File must already exist in the same folder.
*/package com.example.javatextfiles;
...
public class JavaTextFiles {
    /**
     * Main Method recieve input from user and stores it in a float point Array
     * @param args the command line arguments
     */
    public static void main(String[]args) throws Exception {

        File score_f = new File("JavaArrays.txt");// Create a new text file to store the the data of test scores
